...
public class JSONAsyncTask extends AsyncTask<String, String, Boolean> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        indeks = "1010"; // Twój numer indeksu
    ...
    protected Boolean doInBackground(String... params) {
        ...
        publishProgress("Rozpoczęto przetwarzanie zapytania");
        try {
            switch (params[0]) {
                case "read":
                    ReadPost();
    ...
    private void UpdatePost(String indeks, String id, String nick, String text){
        try {
            //Toast.makeText(this.context.getApplicationContext(), "aktualizacja wpisu: " + id + " " + nick + " " + text, Toast.LENGTH_SHORT).show();
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("indeks", indeks);
